/**
  * randomModule.ino by c.d.odom
  * attach this module to any sketch to have easy access
  * to random integer and floating-point numbers.
  * call the seedRNG() function within setup() to seed the
  * random number generator.  Ensure there is nothing connect 
  * to the pin whose number you pass to the function!
**/
